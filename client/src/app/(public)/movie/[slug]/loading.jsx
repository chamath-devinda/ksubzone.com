    ...
    <div className="min-h-screen bg-luxury-950 text-slate-100 pt-20 sm:pt-24 pb-16 animate-pulse">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-8">
        ...
        <div className="mt-8 border-t border-white/10 pt-8 flex flex-col gap-6">
          ...
          <div className="h-32 rounded-2xl bg-luxury-900/50 border border-white/5 p-6 flex items-center justify-between">
            <div className="space-y-3">
              <div className="h-5 w-48 bg-white/10 rounded" />
              <div className="h-4 w-32 bg-white/5 rounded" />
            </div>
            <div className="h-10 w-36 bg-brand-primary/25 rounded-xl border border-brand-primary/35" />
          </div>
        </div>
