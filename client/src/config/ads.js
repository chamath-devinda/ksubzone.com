...
export const adConfig = Object.freeze({
  ...
  routes: {
    ...
    drama: { enabled: true, banner: true, square: true, native: true, sidebar: false, intrusive: true },
    episode: { enabled: true, banner: true, square: true, native: true, sidebar: false, intrusive: true },
    article: { enabled: true, banner: true, square: true, native: true, sidebar: false, intrusive: true },
    search: { enabled: false, banner: false, square: false, native: false, sidebar: false, intrusive: false },
    listing: { enabled: true, banner: true, square: true, native: true, sidebar: false, intrusive: true },
